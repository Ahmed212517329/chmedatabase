...
setup(
  ...
  keywords='chemiformatics, pubchem, conversion, chemical_database',
  packages=find_packages(),
  install_requires=['requests',"rdkit", "pubchempy", "ipywidgets", "pprint","IPython","panel-chemistry", "rdkit-pypi"])
